<?php
    ...
    function sec_session_starr(){
        ...
        session_set_cookie_params($cookie_Params["lifetime"],
            ...
            //Estabelece o nome forecido acima como o nome da sessâo.
    ...
    function login($email, $password, $mysqli){
        ...
        //Usado definiçoes pré-estabelecidas significas que a injeção de sql (um tipo ataque) não é possivel
            ...
            // devido ao limite de tentativas de login ter sido ultrapassado
                ...
                if(checkbrute($user_id, $mysqli)==true){
                    ...
                    if($db_password==$password){
                        ...
                        $username = preg_replace("/[^0-9]+/", "", $user_id);
    ...
    function checkbrute($user_id,$mysqli){
        ...
        //todas as tentativas de login são contadas dentro dointervalo das ultimas 2 horas.
    ...
    function login_check($mysqli) {
        ...
        $_SESSION['login_string'])) {
            ...
            $login_string=$_SESSION['login_id'];
